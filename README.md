...
<a name="zachempokupataktsii"></a>## 1. Зачем покупать акции?
...
<a name="finansovietseli"></a>## 2. Финансовые цели
...
<a name="volshebstvoreinvestirovaniya"></a>## 3. Волшебство реинвестирования
...
<a name="platisebepervomu"></a>## 4. Плати себе первому
...
<a name="trishagaknakopleniu"></a>## 5. Три шага к накоплению
...
<a name="chtotakoeaktsiya"></a>## 7. Что такое акция?
...
<a name="#publichnoerazmeschenie"></a>## 9. Публичное размещение
...
<a name="#fondoviebirzhi"></a>## 10. Фондовые биржи
...
<a name="aktsiiamerikanskihkompaniy"></a>## 12. Акции американских компаний
...
<a name="razmerkompanii"></a>## 13. Размер компании
...
<a name="deshevie"></a>## 14. Дешевые акции
...
<a name="dividendy"></a>## 15. Дивиденды
...
<a name="droblenieaktsiy"></a>## 16. Дробление акций
...
<a name="vidyprikaziv"></a>## 17. Виды приказов (ордеров)
...
<a name="korotkiesdelki"></a>## 19. Короткие сделки
...
Так как самая низкая цена акций может быть равна нулю, когда вы покупаете акции, максимум, что вы можете потерять - это деньги, которые вы вложили. При коротких сделках, нет предела тому, сколько вы можете потерять, так как цена может продолжать расти до бесконечности.
...
<a name="rasshirenniechasy"></a>## 20. Расширенные часы
...
<a name="perviyvzglyad"></a>## 21. Первый взгляд
...
<a name="korporativndyasreda"></a>## 22. Корпоративная среда
...
<a name="dalnovidnyerukovoditely"></a>## 23. Дальновидные руководители
...
<a name="konkurentnoepreimuschestvo"></a>## 24. Конкурентное преимущество
...
<a name="storonniki"></a>## 25. Сторонники
...
<a name="rastuschayaindustriya"></a>## 26. Растущая индустрия
...
<a name="insayderskjevladenie"></a>## 28. Инсайдерское владение
...
<a name="denezhniypotok"></a>## 29. Денежный поток
...
Если Мария идет в Groupon.com и покупает 10-ти долларовый купон за услугу по уходу за ногтями стоимостью $20, Groupon получает от нее $10 сразу. Затем, через месяц Мария использует купон. Через некоторое время после этого, Groupon переводит часть полученных от Марии денег в салон.
...
<a name="denezhnyesredstvaidolgi"></a>## 30. Денежные средства и долги
...
<a name="mudroeispolzovaniesredstv"></a>## 31. Мудрое использование средств
...
<a name="rostprodazh"></a>## 32. Рост продаж
...
<a name="pervayaaktsiya"><a/>## 33. Первая акция
...
<a name="diversifikatsia"></a>## 34. Диверсификация
...
<a name="sozdanieportfelya"></a>## 35. Создание портфеля
...
<a name="riskprotivvoznagrazhdeniya"></a>## 36. Риск против вознаграждения
...
<a name="vremyaicharacter"></a>## 37. Время и характер
...
<a name="izbegayteoshibok"></a>## 38. Избегайте ошибок
...
<a name="kogdaprodavat"></a>## 39. Когда продавать?
...
<a name="takpochemuamerikanskiyrynok"></a>## 40. Так почему американский рынок?
>• Американский фондовый рынок существует больше 200 лет.
>• На фондовом рынке США торгуют 7 000 акциями.
>• Финансовая отчетность эмитентов публикуется в открытом доступе.
>• За последние 40 лет американский рынок вырос в 27 раз.
...
В январе 1980 индекс S&P 500 составлял 106 пунктов, в феврале 2018, даже с учетом падения 9 февраля - 2700 пунктов, что в 27 раз больше. Это с учётом нескольких финансовых кризисов.

И если бы вы 40 лет назад вложили в индексный фонд США $ 1 000, то сейчас бы у вас было $ 27 000.

Если у вас российское гражданство, то налоги вы будете платить только в России, отчитываясь перед налоговой инспекцией, подавая декларацию по форме 3-НДФЛ.

----------
> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTc2NjA5OTBdfQ==
-->